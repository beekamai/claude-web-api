...
def native_tools(
    ...
    if tool_choice == "required":
        if not mapped:
            raise ValueError("tool_choice='required' but no function tools were supplied")
        return mapped
...
def coordinator_envelope(
    ...
    *,
    ...
    instructions = client_instructions(messages) if include_client_instructions else None
    if instructions:
